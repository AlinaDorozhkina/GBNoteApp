package ru.alinadorozhkina.gbnoteapp.ui.customView
...
import ru.alinadorozhkina.gbnoteapp.ui.helpers.dip
...
class ColorCircleView @JvmOverloads constructor(context: Context,
    ...
    @Dimension(unit = PX) var radius: Float = context.dip(defRadiusDp).toFloat()
    ...
    @Dimension(unit = PX) var strokeWidth: Float = context.dip(defStrokeWidthDp).toFloat()
        set(value) {
            field = value
    ...
    init {
        ...
        strokeColorRes = a.getResourceId(
            R.styleable.ColorCircleView_strokeColor, R.color.black)
        a.recycle()
    }
